...
Version  : 3.5.0
Release  : 25
URL      : https://github.com/thom311/libnl/archive/libnl3_5_0/libnl-3.5.0.tar.gz
Source0  : https://github.com/thom311/libnl/archive/libnl3_5_0/libnl-3.5.0.tar.gz
...
%prep
%setup -q -n libnl-libnl3_5_0
cd %{_builddir}/libnl-libnl3_5_0
pushd ..
cp -a libnl-libnl3_5_0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579636088
...
cp %{_builddir}/libnl-libnl3_5_0/COPYING %{buildroot}/usr/share/package-licenses/libnl/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/libnl-libnl3_5_0/doc/COPYING %{buildroot}/usr/share/package-licenses/libnl/8624bcdae55baeef00cd11d5dfcfa60f68710a02
pushd ../build32/
%make_install32
...
/usr/share/package-licenses/libnl/8624bcdae55baeef00cd11d5dfcfa60f68710a02
