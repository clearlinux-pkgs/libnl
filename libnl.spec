...
Version  : 3.11.0
Release  : 27
URL      : https://github.com/thom311/libnl/archive/libnl3_11_0/libnl-3.11.0.tar.gz
Source0  : https://github.com/thom311/libnl/archive/libnl3_11_0/libnl-3.11.0.tar.gz
Summary  : Convenience library for netlink sockets
...
%prep
%setup -q -n libnl-libnl3_11_0
cd %{_builddir}/libnl-libnl3_11_0
pushd ..
cp -a libnl-libnl3_11_0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740682261
...
cp %{_builddir}/libnl-libnl3_11_0/COPYING %{buildroot}/usr/share/package-licenses/libnl/01a6b4bf79aca9b556822601186afab86e8c4fbf || :
cp %{_builddir}/libnl-libnl3_11_0/doc/COPYING %{buildroot}/usr/share/package-licenses/libnl/31a3d460bb3c7d98845187c716a30db81c44b615 || :
export GOAMD64=v2
pushd ../build32/
%make_install32
